...
module.exports = "<p>Litecoin Net Worth: {{ltcPrice*50.5 | currency}}</p>\n<p>Ether Net Worth: {{ethPrice*2 | currency}}</p>\n<p>Net Worth: {{ltcPrice*50.5 + ethPrice*2 | currency}}\n<p [@myAwesomeAnimation]='state' (click)=\"animateMe()\">Some Property: {{someProperty}}</p>\n\n\n\n"
...
var MyNewComponentComponent = (function () {
    function MyNewComponentComponent(dataService) {
        ...
        this.state = 'small';
        this.ltcPrice = 63.63;
        this.ethPrice = 343.97;
    }
    MyNewComponentComponent.prototype.animateMe = function () {
...
MyNewComponentComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        animations: [
            Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["j" /* trigger */])('myAwesomeAnimation', [
                Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["g" /* state */])('small', Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["h" /* style */])({
                    transform: 'scale(1)',
                })),
                Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["g" /* state */])('large', Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["h" /* style */])({
                    transform: 'scale(1.2)',
                })),
                Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["i" /* transition */])('small <=> large', Object(__WEBPACK_IMPORTED_MODULE_2__angular_animations__["e" /* animate */])('300ms ease-in')),
            ]),
        ]
    }),
